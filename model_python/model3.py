...
graph = tf.Graph()
builder = tf.saved_model.builder.SavedModelBuilder('./mod3')
...
cmd1= tf.nn.relu(full_layer(flatten, largura*altura*4))

cmd2= tf.nn.relu(full_layer(cmd1, largura*altura*4))

full_2 = tf.nn.relu(full_layer(cmd2, largura*altura*grupos))
