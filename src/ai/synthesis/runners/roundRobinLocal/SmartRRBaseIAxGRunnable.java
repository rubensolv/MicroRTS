 ...
 * This happens because of the reflection used in the code to rebuild the 
 * IA's with the new UnitTypeTable
 * 
 * @author rubens
 */

public class SmartRRBaseIAxGRunnable extends Thread {
    ...
    public SmartRRBaseIAxGRunnable(iDSL sIA1, AI idIA, boolean side) {
        this.sIA1 = sIA1;        
        this.ai2 = idIA;
    ...
    public int execute() throws Exception {        
        ...
        ai2 = (AI) Class.forName(ai2.getClass().getCanonicalName()).getDeclaredConstructor(utt.getClass()).newInstance(utt);
        if(changeSide){
            AI aiT = ai1;
            ai1 = ai2;
            ai2 = aiT;
...
//        JFrame w = PhysicalGameStatePanel.newVisualizer(gs,640,640,false,PhysicalGameStatePanel.COLORSCHEME_WHITE);        
    ...
    public void run() {
        try {
            ...
            Logger.getLogger(SmartRRBaseIAxGRunnable.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
