...
public class SimpleProgramSynthesisForFPTableV3 implements LocalSearch {
    ...
    public SimpleProgramSynthesisForFPTableV3(SAForFPTableV3 search, List<iDSL> initial_fp_group) {
        this(search);
