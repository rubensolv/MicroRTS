 ...
 * @author rubens
 */
public class CumulativeSimpleProgramSynthesis implements LocalSearch {
    ...
    public CumulativeSimpleProgramSynthesis(CumulativeSAComposed search) {
    ...
    private DetailedSearchResult callAlgorithm(iDSL script1, int count) {
        ...
        try {
            ...
            Logger.getLogger(CumulativeSimpleProgramSynthesis.class.getName()).log(Level.SEVERE, null, ex);
        }
        return results;
    }
