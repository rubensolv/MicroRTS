 ...
 * @author rubens
 */
public class SimpleProgramSynthesisForFPTableV4_unstop_continuous implements LocalSearch {

    //private final String pathTableScripts = System.getProperty("user.dir").concat("/Table/");
    //private ScriptsTable scrTable;
    private SAForFPTableV4_unstop_continuous searchAlgorithm;
    private BuilderDSLTreeSingleton builder;
    private String uniqueID = UUID.randomUUID().toString();
    private HashMap<String, Fp_element> fp_group;

    public SimpleProgramSynthesisForFPTableV4_unstop_continuous(SAForFPTableV4_unstop_continuous search) {
    ...
    public SimpleProgramSynthesisForFPTableV4_unstop_continuous(SAForFPTableV4_unstop_continuous search, List<iDSL> initial_fp_group) {
        this(search);
