 ...
 * @author rubens
 */
public class DoublePortfolioSynthesis implements LocalSearch {
    ...
    public DoublePortfolioSynthesis(SearchImplementation search) {
    ...
    private DetailedSearchResult callAlgorithm(iDSL script1, iDSL script2, float[] itens) {
        ...
        try {
            ...
            Logger.getLogger(DoublePortfolioSynthesis.class.getName()).log(Level.SEVERE, null, ex);
        }
        return results;
    }
