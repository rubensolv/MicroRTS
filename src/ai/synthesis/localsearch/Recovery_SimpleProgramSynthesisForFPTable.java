 ...
 * @author rubens
 */
public class Recovery_SimpleProgramSynthesisForFPTable implements LocalSearch {
    ...
    public Recovery_SimpleProgramSynthesisForFPTable(SAForFPTable search) {
    ...
    public List performRun() {
        ...
        System.out.println("----------------------------------");
        this.uniqueID = "da0fd298-cd23-4fb8-81f0-a5512746b238";
        
        int control = 10;
        int limit = 19;
        //build the opponents' group
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_1.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_2.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_3.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_4.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_5.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_6.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_7.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_8.ser", System.getProperty("user.dir").concat("/logs2/")));
        this.check_inclusion(SerializableController.recoverySerializable("dsl_a7521d58-71c0-44cc-bf5d-1002948c7414_id_9.ser", System.getProperty("user.dir").concat("/logs2/")));
        while (control < limit) {
            check_inclusion(SerializableController.
                    recoverySerializable("dsl_" + uniqueID + "_id_" + control + ".ser",
                            System.getProperty("user.dir").concat("/logs2/")));
            control++;
        }

        iDSL iSc1 = SerializableController.
                recoverySerializable("dsl_" + uniqueID + "_id_" + control + ".ser",
                        System.getProperty("user.dir").concat("/logs2/"));
        control++;
        ...
        DetailedSearchResult res = callAlgorithm(iSc1, control);
        control++;
        for (int i = control; i <= SettingsAlphaDSL.get_number_alphaDSL_iterations(); i++) {
    ...
    private DetailedSearchResult callAlgorithm(iDSL script1, int count) {
        ...
        try {
            ...
            Logger.getLogger(Recovery_SimpleProgramSynthesisForFPTable.class.getName()).log(Level.SEVERE, null, ex);
        }
        return results;
    }
