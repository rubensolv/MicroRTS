 ...
 * @author rubens
 */
public class SimpleProgramSynthesisForFPTableV4_unstoppable implements LocalSearch {

    //private final String pathTableScripts = System.getProperty("user.dir").concat("/Table/");
    //private ScriptsTable scrTable;
    private SAForFPTableV4_unstoppable searchAlgorithm;
    private BuilderDSLTreeSingleton builder;
    private String uniqueID = UUID.randomUUID().toString();
    private HashMap<String, Fp_element> fp_group;

    public SimpleProgramSynthesisForFPTableV4_unstoppable(SAForFPTableV4_unstoppable search) {
    ...
    public SimpleProgramSynthesisForFPTableV4_unstoppable(SAForFPTableV4_unstoppable search, List<iDSL> initial_fp_group) {
        this(search);
