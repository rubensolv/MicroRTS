 ...
 * @author rubens
 */
public class SAForFPTableV5_windows extends SearchImplementationAbstract {
    ...
    public DetailedSearchResult run(iDSL sc_improve, Collection<Fp_element> sc_base) {
        ...
        try {
            ...
            Logger.getLogger(SAForFPTableV5_windows.class.getName()).log(Level.SEVERE, null, ex);
