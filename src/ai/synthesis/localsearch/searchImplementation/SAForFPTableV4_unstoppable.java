 ...
 * @author rubens
 */
public class SAForFPTableV4_unstoppable extends SearchImplementationAbstract {
    ...
    public DetailedSearchResult run(Collection<Fp_element> sc_base) {
        ...
        try {
            ...
            Logger.getLogger(SAForFPTableV4_unstoppable.class.getName()).log(Level.SEVERE, null, ex);
