...
public class ThreadBattleWithLogClone implements Runnable {
    ...
    public ThreadBattleWithLogClone(AI ai1, AI ai2, String sMap, String sIte, String pathLog, 
            String id1, String id2, String uniqueID, UnitTypeTable utt, GameState gs) {
        this.ai1 = ai1.clone();
        this.ai2 = ai2.clone();        
        this.sMap = sMap;
        this.sIte = sIte;
    ...
    public void run() {
        try {
            ...
            if (gs.getPhysicalGameState().getHeight() == 8) {
                MAXCYCLES = 3000;
            } else if (gs.getPhysicalGameState().getHeight() == 16) {
                MAXCYCLES = 4000;
            } else if (gs.getPhysicalGameState().getHeight() == 24) {
                MAXCYCLES = 5000;
            } else if (gs.getPhysicalGameState().getHeight() == 32) {
                MAXCYCLES = 6000;
            } else if (gs.getPhysicalGameState().getHeight() == 64) {
                MAXCYCLES = 8000;
            }
