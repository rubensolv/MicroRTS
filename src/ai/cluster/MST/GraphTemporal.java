 ...
 * @author rubens
 */
public class GraphTemporal {

    private List<Nodo> graph;
    double gama = 0.9;

    public GraphTemporal() {
    ...
    private void addNodeRelation(Pair<Unit, UnitAction> action, Unit enemy, GameState gameState) {
        ...
        double edgeValue = un.getAttackRange() - Math.pow(gama, (gameState.getTime()/10));
        searchAly.addNodeAdj(edgeValue, searchEn);
    }
