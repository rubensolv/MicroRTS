 ...
 * @author rubens
 */
public class GAB_normalScore extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public GAB_normalScore(UnitTypeTable utt) {
    ...
    public GAB_normalScore(int time, int max_playouts, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    @Override
    public AI clone() {
        return new GAB_normalScore(_time, _max_playouts, evaluation, utt, pf);
    }
