 ...
 */
public class IDABCDAsymmetricSandBox extends AIWithComputationBudget implements InterruptibleAI {
    ...
    AI playoutAI = null;
    AI playoutAIEnemy = null;
    int maxPlayoutTime = 150;
    ...
    public IDABCDAsymmetricSandBox(UnitTypeTable utt) {
        this(100, -1,
                new POWorkerRush(utt, new AStarPathFinding()), 150,
                new SimpleSqrtEvaluationFunction3(), true);
    }

    public IDABCDAsymmetricSandBox(int tpc, int ppc, AI a_playoutAI, int a_maxPlayoutTime, EvaluationFunction a_ef, boolean a_performGreedyActionScan) {
        super(tpc, ppc);
    ...
    public AI clone() {
        return new IDABCDAsymmetricSandBox(TIME_BUDGET, ITERATIONS_BUDGET, playoutAI, maxPlayoutTime, ef, performGreedyActionScan);
    }
...
//            return bestMove;
        ...
        //System.out.println("Starting realTimeMinimaxABIterativeDeepening... (time  " + gs_to_start_from.getTime() + ")");
        do {
            if (stack != null) {
                depth = last_depth;
            }
...
//        System.out.println("searchOutsideStack: stack is not empty.");
    ...
    public AI getPlayoutAIEnemy() {
        return playoutAIEnemy;
    }

    public void setPlayoutAIEnemy(AI playoutAIEnemy) {
        this.playoutAIEnemy = playoutAIEnemy;
    }
