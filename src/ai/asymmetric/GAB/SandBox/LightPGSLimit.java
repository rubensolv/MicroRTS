 ...
 * @author rubens
 */
public class LightPGSLimit extends AIWithComputationBudget implements InterruptibleAI{
    ...
    public LightPGSLimit(UnitTypeTable utt) {
        this(100, -1, 200, 4, 4, 
    ...
    public LightPGSLimit(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    */
    ...
    @Override
    public AI clone() {
        return new LightPGSLimit(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }
