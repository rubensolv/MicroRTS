 ...
 *
 */
public class GAB_ABActionGeneration extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public GAB_ABActionGeneration(UnitTypeTable utt) {
    ...
    public GAB_ABActionGeneration(int time, int max_playouts, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf, int numUnits, int numManager) {
    ...
    @Override
    public AI clone() {
        return new GAB_ABActionGeneration(_time, _max_playouts, evaluation, utt, pf, _numUnits, _numManager);
    }
    ...
    public String toString() {
        return "GAB_ABActionGeneration{" + "_numUnits=" + _numUnits + ", manager=" + _numManager + '}';
    }
