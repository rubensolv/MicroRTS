 ...
 * UnitScriptData. 
 *  baseado no GAB_ABActionGeneration
 */
public class GAB_ScriptC extends AIWithComputationBudget implements InterruptibleAI {
    
    EvaluationFunction evaluation = null;
    UnitTypeTable utt;
    PathFinding pf;
    PGSLimitScriptC _pgs = null;
    ...
    public GAB_ScriptC(UnitTypeTable utt) {
    ...
    public GAB_ScriptC(UnitTypeTable utt , List<AI> scripts) {
        this(100, 200,new SimpleSqrtEvaluationFunction3(),
             //new SimpleSqrtEvaluationFunction2(),
             //new LanchesterEvaluationFunction(),
             utt,
    ...
    public GAB_ScriptC(UnitTypeTable utt , List<AI> scripts, String tuplaIndSc) {
        this(100, 200,new SimpleSqrtEvaluationFunction3(),
             //new SimpleSqrtEvaluationFunction2(),
             //new LanchesterEvaluationFunction(),
             utt,
    ...
    public GAB_ScriptC(int time, int max_playouts, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf, int numUnits, int numManager) {
        super(time, max_playouts);
        
        evaluation = e;
        utt = a_utt;
        pf = a_pf;
        _pgs = new PGSLimitScriptC(utt);
    ...
    @Override
    public AI clone() {
        return new GAB_ScriptC(_time, _max_playouts, evaluation, utt, pf, _numUnits, _numManager);
    }
    ...
    public PlayerAction getBestActionSoFar() throws Exception {
        long start = System.currentTimeMillis();
         ...
         if( (System.currentTimeMillis()-start)< (TIME_BUDGET-10) ){
            ...
            _ab.setTimeBudget(TIME_BUDGET -timeUsed);
            }else{
    ...
    public String toString() {
        return "GAB_ScriptC{" + "_numUnits=" + _numUnits + ", manager=" + _numManager +" indice="+tuplaInScripts +'}';
    }
