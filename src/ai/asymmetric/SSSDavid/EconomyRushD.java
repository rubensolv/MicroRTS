 ...
 * @author rubensolv
 */
public class EconomyRushD extends AbstractionLayerAID {
    ...
    public EconomyRushD(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

    public EconomyRushD(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public void workersBehavior(List<Unit> workers, Player p,  GameState gs,Information inf) {
        ...
        int basex=-1;
        int basey=-1;
       // if(gs.getTime() < 10)System.out.println("dddddddddddd "+ inf.barraca_tempo );
        for (Unit u2 : pgs.getUnits()) {
       ...
       // System.out.println("kkkkk "+ nbarracks );
