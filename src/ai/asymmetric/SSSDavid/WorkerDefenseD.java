...
import java.util.LinkedList;
	...
	public class WorkerDefenseD extends AbstractionLayerAI {
	    Random r = new Random();
	    ...
	    public WorkerDefenseD(UnitTypeTable a_utt) {
	        this(a_utt, new AStarPathFinding());
	    }

	        
	    public WorkerDefenseD(UnitTypeTable a_utt, PathFinding a_pf) {
	        super(a_pf);
	        reset(a_utt);
	    }
	    ...
	    public AI clone() {
	        return new WorkerDefenseD(utt, pf);
	    }
