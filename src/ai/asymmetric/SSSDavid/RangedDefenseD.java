...
public class RangedDefenseD extends AbstractionLayerAI {
    ...
    public RangedDefenseD(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    
    public RangedDefenseD(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    public AI clone() {
        return new HeavyDefenseD(utt, pf);
    }
