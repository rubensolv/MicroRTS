...
public class LightDefenseD extends AbstractionLayerAI {
    ...
    public LightDefenseD(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    
    public LightDefenseD(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
