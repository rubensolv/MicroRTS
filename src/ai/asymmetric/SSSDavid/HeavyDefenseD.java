...
public class HeavyDefenseD extends AbstractionLayerAI {
    ...
    public HeavyDefenseD(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    
    public HeavyDefenseD(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
