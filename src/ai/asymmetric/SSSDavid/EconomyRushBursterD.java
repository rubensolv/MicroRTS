 ...
 * @author rubensolv
 */
public class EconomyRushBursterD extends AbstractionLayerAI {
    ...
    public EconomyRushBursterD(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }

    public EconomyRushBursterD(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
    ...
    @Override
    public AI clone() {
        return new EconomyRushBursterD(utt, pf);
    }
    ...
    public void workersBehavior(List<Unit> workers, Player p,  GameState gs,Information inf) {
        ...
        if (nbarracks != 0 && !inf.contruindo_barraca) {
