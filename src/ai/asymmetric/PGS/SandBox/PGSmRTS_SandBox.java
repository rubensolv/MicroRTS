 ...
 * @author rubens
 */
public class PGSmRTS_SandBox extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public PGSmRTS_SandBox(UnitTypeTable utt) {
        this(100, -1, 300, 1, 1,
    ...
    public PGSmRTS_SandBox(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    * Executa um playout de tamanho igual ao @LOOKAHEAD e retorna o valor
    ...
    @Override
    public AI clone() {
        return new PGSmRTS_SandBox(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }
