 ...
 * @author rubens
 */
public class A3NNoWaitGenerator implements ICMAB_ActionGenerator{
    ...
    public A3NNoWaitGenerator( GameState gs_to_start_from, int playerForThisComputation, UnitTypeTable a_utt, String Behavior, int qtdUNits, List<AI> abstraction) throws Exception{
