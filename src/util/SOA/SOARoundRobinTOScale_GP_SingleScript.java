 ...
 */
public class SOARoundRobinTOScale_GP_SingleScript {
    ...
    private static boolean processarMatch(String pathLog, String arquivo, int map) {
        ...
        RoundRobinTOScale_GP_SingleScript control = new RoundRobinTOScale_GP_SingleScript(pathTableScripts,pathLogsGrammars);
        try {
            ...
            Logger.getLogger(SOARoundRobinTOScale_GP_SingleScript.class.getName()).log(Level.SEVERE, null, ex);
        }
        return false;
    }
