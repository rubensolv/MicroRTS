...
def cria_model():
    ...
    cmd1 = tf.keras.layers.Dense(4*largura*altura,activation='relu',kernel_initializer='random_uniform')(flatten)
    d_cmd1 = tf.keras.layers.Dropout(.2)(cmd1)
    cmd = tf.keras.layers.Dense(4*largura*altura,activation='relu',kernel_initializer='random_uniform')(d_cmd1)
